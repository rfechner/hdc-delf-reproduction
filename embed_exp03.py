...
bxs = np.random.uniform(-1, 1, size=(nx + 1, d))
bys = np.random.uniform(-1, 1, size=(ny + 1, d))
...
def main():
    ...
    for pickle_name in pickle_names:
        ...
        # Normalize database
        features_db = standartize_per_image(features_db)
        ...
        features_q = standartize_per_image(features_q)
